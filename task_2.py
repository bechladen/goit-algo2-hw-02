...
def optimize_printing(print_jobs: List[Dict], constraints: Dict) -> Dict:
    ...
    Правила (у стилі лекції про жадібні алгоритми):
    - спочатку друкуємо завдання з вищим пріоритетом (1 -> 2 -> 3)
    - далі жадібно формуємо групи для одночасного друку, поки влазить у ліміти
